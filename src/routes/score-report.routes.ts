 ...
 */
router.get('/:id', authenticate, scoreReportController.getScoreReport);
 ...
 *         description: Score report not found
 */
router.post('/:id/generate', authenticate, scoreReportController.enqueueScoreReportGeneration);
