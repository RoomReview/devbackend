...
router.get('/', validateRequest({ query: PaginationQueryDto }), postcodeController.getAllPostcodes);
router.get('/code/:code', postcodeController.getPostcodeByCode);
router.get('/code/:code/report-data', postcodeController.getPostcodeReportDataByCode);
...
router.delete('/:id', authenticate, authorize('manage:locations'), postcodeController.deletePostcode);
